...
void telaPause(){//---------------------------------------------------FUNCAO RESPONSALVEL PELO PAUSE
    al_draw_bitmap(btPlay, posXBtPlay, posYBtPlay, 0);
    al_draw_bitmap(btExit, posXBtExit, posYBtExit, 0);
    al_draw_bitmap(backGroundPause, 50, 0, 0);
...
void telaJogo(){//----------------------------------------------------FUNCAO RESPONSALVEL PELO JOGO
    ...
    //al_draw_bitmap(fogo, posXFogo+10, posYNave-10, 0);
...
int main(void){
    ...
    backGroundEscolha = al_load_bitmap("img/background.jpg");
    backGroundPause = al_load_bitmap("img/telaPause.jpg");
    backGroundRanking = al_load_bitmap("img/gameover.jpg");
    nave[0][0] = al_load_bitmap ("img/nave.png");
    nave[0][1] = al_load_bitmap ("img/nave.png");
    nave[0][2] = al_load_bitmap ("img/nave.png");
    nave[1][0] = al_load_bitmap ("img/nave.png");
    nave[1][1] = al_load_bitmap ("img/nave.png");
    nave[1][2] = al_load_bitmap ("img/nave.png");
    nave[2][0] = al_load_bitmap ("img/nave.png");
    nave[2][1] = al_load_bitmap ("img/nave.png");
    nave[2][2] = al_load_bitmap ("img/nave.png");
    //nave = al_load_bitmap ("img/nave.png");
    //nave1 = al_load_bitmap ("img/nave_colisao1.png");
    //nave2 = al_load_bitmap ("img/nave_colisao2.png");
    //nave3 = al_load_bitmap ("img/darth.png");
