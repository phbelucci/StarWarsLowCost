...
int vidas = 3;
char nomePlayer[TAMANHO_NOME_PLAYER]={"DIGITE SEU NOME AQUI"};
int indexNome = -1;
...
void resetJogo(){
if (cenarioClick == 1){
        backGround = al_load_bitmap         ("img/back/1920/cenario/testebackcidade.jpg");
        backGroundExplo = al_load_bitmap    ("img/back/1920/cenario/testebackcidade.jpg");
        rTime = 255;
        gTime = 0;
        bTime = 100;
...
void telaEscolha(){//----------------------------------------------------FUNCAO RESPONSALVEL PELO MENU
     ...
     al_draw_textf(textRank, al_map_rgb(255, 255, 0), 950, 631, ALLEGRO_ALIGN_CENTER, "%s",nomePlayer);

     if(indexNome==0){
        strcpy(nomePlayer,"DIGITE SEU NOME AQUI");
     }
     if(caracterPendente){
        if(indexNome<0){
            indexNome = 0;
...
int abreArquivoDisco(char rankingPlayers[][50], int numJogadores, int score[]){
    ...
    for(i=0;i<NUM_JOGADORES;i++){
        ...
        fscanf(arq,"%i", &score[i]); //Lê a pontuacao e armazena
        fgets(&rankingPlayers[i],50,arq);  //Lê o Nome do Player e armazena
    }
...
void telaRanking(){//-------------------------------------------------FUNCAO RESPONSALVEL PELO RANKING
    ...
    char rankingPlayers[NUM_JOGADORES][50],scoreTexto[10];
    ...
    //RANKING PLAYERS
    al_draw_textf(textRank, al_map_rgb(255, 255, 0), 270, 200, ALLEGRO_ALIGN_LEFT, "PLAYER 1: %i",somaScore*progressao);
    al_draw_textf(textRank, al_map_rgb(255, 255, 0), 270, 260, ALLEGRO_ALIGN_LEFT, "PLAYER 2: %i",somaScore*progressao);
    al_draw_textf(textRank, al_map_rgb(255, 255, 0), 270, 320, ALLEGRO_ALIGN_LEFT, "PLAYER 3: %i",somaScore*progressao);
    al_draw_textf(textRank, al_map_rgb(255, 255, 0), 270, 380, ALLEGRO_ALIGN_LEFT, "PLAYER 4: %i",somaScore*progressao);
    al_draw_textf(textRank, al_map_rgb(255, 255, 0), 270, 440, ALLEGRO_ALIGN_LEFT, "PLAYER 5: %i",somaScore*progressao);
...
int main(void){
    ...
    backGround =            al_load_bitmap("img/back/1920/cenario/testebackcidade.jpg");
    backGroundCidade =      al_load_bitmap("img/back/1920/cenario/testebackcidade.jpg");
    ...
    nave[0][1] =            al_load_bitmap("img/naves/naveZeroEstadoZero.png");
    nave[0][2] =            al_load_bitmap("img/naves/naveZeroEstadoZero.png");
    ...
    textTime =              al_load_font("fonte/alarm_clock/alarm_clock.ttf", 60, ALLEGRO_TTF_NO_KERNING);
    textRank =              al_load_font("fonte/alarm_clock/alarm_clock.ttf", 40, ALLEGRO_TTF_NO_KERNING);
    textScoreJogo =         al_load_font("fonte/alarm_clock/alarm_clock.ttf", 60, ALLEGRO_TTF_NO_KERNING);
        ...
        if (evento.type == ALLEGRO_EVENT_KEY_DOWN){
            ...
            switch(evento.keyboard.keycode){
                ...
                case ALLEGRO_KEY_SPACE:
                    al_draw_bitmap(vida1,posXNave+20,posYNave+10,0);
                    velvida = posXVida1+(velNave*1.2);
                break;
