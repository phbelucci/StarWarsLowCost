...
void loadBitmap(){
    ...
    naveImagem[0][0] =                   al_load_bitmap("img/naves/naveZeroEstadoZero.png");
    naveImagem[0][1] =                   al_load_bitmap("img/naves/naveZeroEstadoUm.png");
    naveImagem[0][2] =                   al_load_bitmap("img/naves/naveZeroEstadoDois.png");
    naveImagem[1][0] =                   al_load_bitmap("img/naves/naveUmEstadoZero.png");
    naveImagem[1][1] =                   al_load_bitmap("img/naves/naveUmEstadoUm.png");
    naveImagem[1][2] =                   al_load_bitmap("img/naves/naveUmEstadoDois.png");
    naveImagem[2][0] =                   al_load_bitmap("img/naves/naveDoisEstadoZero.png");
    naveImagem[2][1] =                   al_load_bitmap("img/naves/naveDoisEstadoUm.png");
    naveImagem[2][2] =                   al_load_bitmap("img/naves/naveDoisEstadoDois.png");
    ...
    obst.objetoBitmap =                  al_load_bitmap("img/asteroide.png");
    obst2.objetoBitmap =                 al_load_bitmap("img/asteroide.png");
    obst3.objetoBitmap =                 al_load_bitmap("img/asteroide.png");
    obst4.objetoBitmap =                 al_load_bitmap("img/asteroide.png");
...
void drawTelaJogo (){
    ...
    if(tiro1.ativo)al_draw_bitmap(tiro1.objetoBitmap, tiro1.posX, tiro1.posY, 0);
    if(tiro2.ativo)al_draw_bitmap(tiro2.objetoBitmap, tiro2.posX, tiro2.posY, 0);
    if(tiro3.ativo)al_draw_bitmap(tiro3.objetoBitmap, tiro3.posX, tiro3.posY, 0);
